...
def read_controls(controls, folder_name):
	...
	return controls
		#print(filename)
def read_dialogue(robot_start, dial_in_name):
	...
	for line in dial_in.readlines():
		...
		if m:
			...
			robot_start.append((time,utt))
			
			#count+=1
	robot_start.append("END_OF_FILE")
	return robot_start
	

def read_asr(asr_in_name, asr_robot_start, asr_robot_end, asr_input):
