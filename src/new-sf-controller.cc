...
void SFController::hear(Vector<BaseFloat>* data) {
	...
	//cerr << "should listen " << should_listen << " robotSpeaking " << robotSpeaking 
		//<< " lm ready " << decoder->lm_ready << endl;
		
	if (should_listen && !robotSpeaking && decoder->lm_ready) {
...
void SFController::process_yarp_msg(string str) {
