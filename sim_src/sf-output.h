 ...
 * @param simulator Controller instance
 ...
 */
    SFOutput(Simulator *simulator, char* source, const char* base_name, const char* output_path);
	...
	void write_readback_actual(MatrixIndexT size);
protected:
